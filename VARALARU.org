#+auto_tangle:t
* Log
- 2026-01-19T23-25 Files under ~tharavu/lengthwise/~ are produced by the following command
  #+begin_src shell
    time kkk split_by_length --input ../ilakkani/mlm/tharavu/words.clean.sorted.tsv --output-pattern tharavu/lengthwise/words-{:03d}.txt
  #+end_src
